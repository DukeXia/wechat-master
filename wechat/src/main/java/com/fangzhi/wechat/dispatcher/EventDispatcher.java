package com.fangzhi.wechat.dispatcher;
...
import com.fangzhi.wechat.common.GetUseInfo;
import com.fangzhi.wechat.message.resp.Article;
import com.fangzhi.wechat.message.resp.Image;
import com.fangzhi.wechat.message.resp.ImageMessage;
import com.fangzhi.wechat.message.resp.NewsMessage;
import com.fangzhi.wechat.util.HttpPostUploadUtil;
import com.fangzhi.wechat.util.MessageUtil;
	...
	public static String processEvent(Map<String, String> map) {
		...
		if (map.get("Event").equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) { // 关注事件
			...
			try {
					...
					article.setDescription("欢迎来到dukexia的个人博客：菜鸟程序员成长之路！"); //图文消息的描述
